...
CREATE TABLE `bookingslot` (
  ...
  `VehicleID` int NOT NULL,
  PRIMARY KEY (`BSlotID`),
  CONSTRAINT `bookingslot_ibfk_1` FOREIGN KEY (`VehicleID`) REFERENCES `vehicle` (`VehicleID`),
  CONSTRAINT `bookingslot_ibfk_2` FOREIGN KEY (`SNo`) REFERENCES `user` (`UserID`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `owner` (
  ...
  `SNo` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`OwnerID`),
  CONSTRAINT `owner_ibfk_1` FOREIGN KEY (`SNo`) REFERENCES `user` (`UserID`)
...
CREATE TABLE `payment` (
  ...
  CONSTRAINT `payment_ibfk_1` FOREIGN KEY (`SNo`) REFERENCES `user` (`UserID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `payment_ibfk_2` FOREIGN KEY (`VehicleID`) REFERENCES `vehicle` (`VehicleID`) ON DELETE CASCADE ON UPDATE CASCADE
